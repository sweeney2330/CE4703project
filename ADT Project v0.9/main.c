...
int main(){ 
  ...
  // TREVOR - DOUBLE CHECK THE ORDER OF OPERATIONS
  printf("*************************************************************************\n");
  printf("*\tTEST MAIN FOR POLYNOMIALS IMPLEMENTED IN DYNAMIC ARRAYS\t\t*\n");
  printf("*\tEach test case does the following:\t\t\t\t* \n");
  printf("*\t(1) Arithmetic operation\t\t\t\t\t*\n");
  printf("*\t(2) Print the result\t\t\t\t\t\t*\n");
  printf("*\t(3) Delete the result\t\t\t\t\t\t*\n");
  printf("*************************************************************************\n");
  ...
  printf("Expected A + B = 5.00x^2 + 1.00x^1 + 25.00x^0\n");
  ...
  printf("Expected A * 5.00 = 0.00x^2 - 20.00x^1 + 100.00x^0\n");
  ...
  printf("Expected Noramlised (A) = +- 0.00x^2 + 1.00x^1 - 5.00x^0\n");
